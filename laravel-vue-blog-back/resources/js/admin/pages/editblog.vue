<template>
    <div>
			<div class="container-fluid">
				...
				<div class="_input_field">
                          <Button @click="save" :loading="isCreating" :disable="isCreating">{{isCreating ? 'Please Wait..' : 'Update Blog'}}</Button>
                       </div>
				</div>
...
export default{
    ...
    methods:{
        ...
        async onSave(response){
           ...
           if(res.status == 200){
               this.s('Blog Has Been Updated Succesfully')
        ...
        async created(){
            ...
            if([blog,cat,tag].status = 200){
                ...
                this.data.post_except = blog.data.post_except
            }else{
                this.swr()
            }
        }
